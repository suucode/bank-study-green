...
public class AccountRepositoryTest extends DummyEntity {
    ...
    @Autowired
    private EntityManager em; //autoIncrement 를 초기화시키기위해서 필요
    ...
    public void setUp() { //테스트전 데이터 입력
        ...
        Account ssarAccount2 = accountRepository.save(newAccount(1111L, ssar));
    }

    //후
    @AfterEach
    public void tearDown() { //JpaTest는 Transactional 어노테이션이 있어서 메서드 실행 직후 자동 롤백됨
